[![Build Status](https://dev.azure.com/DevOpsTrainingForMe/MyNewProject/_apis/build/status%2Fpython-sample-vscode-flask-tutorial?branchName=main)](https://dev.azure.com/DevOpsTrainingForMe/MyNewProject/_build/latest?definitionId=3&branchName=main)
